...
echo "Received source branch as $SourceBranch"

$CleanedSourceBranch=$SourceBranch.Replace("refs/heads/","")
echo "Cleaned source branch to $CleanedSourceBranch"

$TargetBranch=$tar_branch
echo "Received target branch as $TargetBranch"

$CleanedTargetBranch=$TargetBranch.Replace("refs/heads/","")
echo "Cleaned target branch to $CleanedTargetBranch"
